...
import com.khulnasoft.oss.driver.api.core.`type`.{UserDefinedType => DriverUserDefinedType}
import com.khulnasoft.oss.driver.api.core.metadata.Metadata
import com.khulnasoft.oss.driver.api.core.metadata.schema._
import com.khulnasoft.oss.driver.api.core.{CqlIdentifier, CqlSession, ProtocolVersion}
import com.khulnasoft.spark.connector._
import com.khulnasoft.spark.connector.mapper.ColumnMapper
import com.khulnasoft.spark.connector.types.{ColumnType, CounterType, UserDefinedType}
import com.khulnasoft.spark.connector.util.DriverUtil.{toName, toOption}
...
object TableDef {
  ...
  /** Constructs a table definition based on the mapping provided by
    * appropriate [[com.khulnasoft.spark.connector.mapper.ColumnMapper]] for the given type. */
