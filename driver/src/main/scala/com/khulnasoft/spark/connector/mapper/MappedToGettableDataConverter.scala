...
import com.khulnasoft.spark.connector.cql.StructDef
import com.khulnasoft.spark.connector.types._
import com.khulnasoft.spark.connector.util.{Logging, ReflectionUtil, Symbols}
import com.khulnasoft.spark.connector.{ColumnRef, GettableByIndexData}
  ...
  def apply[T : TypeTag : ColumnMapper](
    ...
    new TypeConverter[struct.ValueRepr] {
      ...
      /** Returns the column mapper associated with the given type.
        ...
        * For tuples, returns [[com.khulnasoft.spark.connector.mapper.TupleColumnMapper TupleColumnMapper]],
        * for Java beans uses
        * [[com.khulnasoft.spark.connector.mapper.JavaBeanColumnMapper JavaBeanColumnMapper]],
        * and for everything else uses
        * [[com.khulnasoft.spark.connector.mapper.DefaultColumnMapper DefaultColumnMapper]] */
