...
import com.khulnasoft.oss.driver.api.core.cql.{AsyncResultSet, ColumnDefinitions, PreparedStatement, ResultSet, Row}
...
/** Represents a single row fetched from Cassandra.
  ...
  * [[com.khulnasoft.spark.connector.types.TypeConversionException]] is thrown.
  *
