# KhulnaSoft Connector for Apache Spark to Apache Cassandra

*Lightning-fast cluster computing with Apache Spark&trade; and Apache Cassandra&reg;.*

[![CI](https://github.com/khulnasoft/spark-cassandra-connector/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/khulnasoft/spark-cassandra-connector/actions?query=branch%3Amaster)
...
| Scala Docs | Most Recent Release (3.5.1): [Connector API docs](https://khulnasoft.github.io/spark-cassandra-connector/ApiDocs/3.5.1/connector/com/khulnasoft/spark/connector/index.html), [Connector Driver docs](https://khulnasoft.github.io/spark-cassandra-connector/ApiDocs/3.5.1/driver/com/khulnasoft/spark/connector/index.html) |
| Latest Production Release | [3.5.1](https://search.maven.org/artifact/com.khulnasoft.spark/spark-cassandra-connector_2.12/3.5.1/jar)                                                                                                                                                                                                              |
...
3.5.x ([master](https://github.com/khulnasoft/spark-cassandra-connector/tree/master)),
3.4.x ([b3.4](https://github.com/khulnasoft/spark-cassandra-connector/tree/b3.4)),
3.3.x ([b3.2](https://github.com/khulnasoft/spark-cassandra-connector/tree/b3.3)),
3.2.x ([b3.2](https://github.com/khulnasoft/spark-cassandra-connector/tree/b3.2)),
3.1.x ([b3.1](https://github.com/khulnasoft/spark-cassandra-connector/tree/b3.1)),
3.0.x ([b3.0](https://github.com/khulnasoft/spark-cassandra-connector/tree/b3.0)) and 
2.5.x ([b2.5](https://github.com/khulnasoft/spark-cassandra-connector/tree/b2.5)).
...
### 3.5.1
* [Spark-Cassandra-Connector](https://khulnasoft.github.io/spark-cassandra-connector/ApiDocs/3.5.1/connector/com/khulnasoft/spark/connector/index.html)

### 3.5.0
* [Spark-Cassandra-Connector](https://khulnasoft.github.io/spark-cassandra-connector/ApiDocs/3.5.0/connector/com/khulnasoft/spark/connector/index.html)

### 3.4.1
* [Spark-Cassandra-Connector](https://khulnasoft.github.io/spark-cassandra-connector/ApiDocs/3.4.1/connector/com/khulnasoft/spark/connector/index.html)

### 3.3.0
* [Spark-Cassandra-Connector](https://khulnasoft.github.io/spark-cassandra-connector/ApiDocs/3.3.0/connector/com/khulnasoft/spark/connector/index.html)

### 3.2.0
* [Spark-Cassandra-Connector](https://khulnasoft.github.io/spark-cassandra-connector/ApiDocs/3.2.0/connector/com/khulnasoft/spark/connector/index.html)

### 3.1.0
* [Spark-Cassandra-Connector](https://khulnasoft.github.io/spark-cassandra-connector/ApiDocs/3.1.0/connector/com/khulnasoft/spark/connector/index.html)

### 3.0.1
* [Spark-Cassandra-Connector](https://khulnasoft.github.io/spark-cassandra-connector/ApiDocs/3.0.1/connector/com/khulnasoft/spark/connector/index.html)

### 2.5.2
* [Spark-Cassandra-Connector](https://khulnasoft.github.io/spark-cassandra-connector/ApiDocs/2.5.2/connector/#package)

### 2.4.2
* [Spark-Cassandra-Connector](http://khulnasoft.github.io/spark-cassandra-connector/ApiDocs/2.4.2/spark-cassandra-connector/)
* [Embedded-Cassandra](http://khulnasoft.github.io/spark-cassandra-connector/ApiDocs/2.4.2/spark-cassandra-connector-embedded/)
...
SBT config:
    ...
    libraryDependencies += "com.khulnasoft.spark" %% "spark-cassandra-connector" % "3.5.1"
...
Questions and requests for help may be submitted to the [user mailing list](https://groups.google.com/a/lists.khulnasoft.com/forum/#!forum/spark-connector-user).


## Q/A Exchange

The [KhulnaSoft Community](https://community.khulnasoft.com/index.html) provides a free question and answer website for any and all
questions relating to any KhulnaSoft Related technology. Including the Spark Cassandra Connector. Both KhulnaSoft 
engineers and community members frequent this board and answer questions.

## Contributing

To protect the community, all contributors are required to sign the [KhulnaSoft Spark Cassandra Connector Contribution License Agreement](https://cla.khulnasoft.com/). The process is completely electronic and should only take a few minutes.
...
Copyright 2014-2022, KhulnaSoft, Inc.
