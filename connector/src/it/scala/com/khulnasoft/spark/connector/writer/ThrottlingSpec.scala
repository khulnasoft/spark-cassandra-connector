...
import com.khulnasoft.spark.connector.{SomeColumns, SparkCassandraITFlatSpecBase}
...
//      poolingOptions.setConnectionsPerHost(com.khulnasoft.driver.core.HostDistance.LOCAL, 1, 1)
    }
