...
import com.khulnasoft.oss.driver.api.core.{CqlIdentifier, CqlSession, DefaultProtocolVersion}
import com.khulnasoft.oss.driver.api.core.`type`.DataTypes
import com.khulnasoft.oss.driver.api.core.metadata.schema.ClusteringOrder
...
import com.khulnasoft.spark.connector.cql.{AuthConf, AuthConfFactory, CassandraConnectionFactory, CassandraConnector, CassandraConnectorConf, ClusteringColumn, DefaultConnectionFactory, NoAuthConf}
import com.khulnasoft.spark.connector.util.DriverUtil.toName
