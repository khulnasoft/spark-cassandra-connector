...
import com.khulnasoft.spark.connector.japi.rdd.CassandraJavaRDD;
import com.khulnasoft.spark.connector.japi.rdd.CassandraTableScanJavaRDD;
import com.khulnasoft.spark.connector.rdd.CassandraRDD;
import com.khulnasoft.spark.connector.rdd.CassandraTableScanRDD;
import com.khulnasoft.spark.connector.rdd.CassandraTableScanRDD$;
import com.khulnasoft.spark.connector.rdd.reader.RowReaderFactory;

import static com.khulnasoft.spark.connector.util.JavaApiHelper.getClassTag;
...
public class SparkContextJavaFunctions {
    ...
    /**
     * Returns a view of a Cassandra table as a {@link com.khulnasoft.spark.connector.japi.rdd.CassandraJavaRDD}.
     *
     ...
     * com.khulnasoft.spark.connector.japi.CassandraJavaUtil}.</p>
     *
     ...
     *
     * @return {@link com.khulnasoft.spark.connector.japi.rdd.CassandraJavaRDD} of type {@code T}
     *
     * @since 1.1.0
     */
