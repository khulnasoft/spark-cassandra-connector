...
import com.khulnasoft.spark.connector.BatchSize;
...
import com.khulnasoft.spark.connector.writer.*;
...
import static com.khulnasoft.spark.connector.japi.CassandraJavaUtil.allColumns;

/**
 * Java API wrapper over either {@code RDD} or {@code DStream} for the KhulnaSoft Connector for Apache Spark to Apache Cassandra.
 *
...
public abstract class RDDAndDStreamCommonJavaFunctions<T> {
     ...
     *
     * @return an instance of {@link com.khulnasoft.spark.connector.cql.CassandraConnector}
     */
     ...
     *
     * @return an instance of {@link com.khulnasoft.spark.connector.writer.WriteConf}
     */
     ...
     * com.khulnasoft.spark.connector.writer.RowWriterFactory)}
     */
    @Deprecated
     ...
     *
     * <p>To obtain an instance of {@link com.khulnasoft.spark.connector.writer.RowWriterFactory} use one of utility
     * methods in {@link com.khulnasoft.spark.connector.japi.CassandraJavaUtil}.</p>
     *
     ...
     *
     * @return an instance of {@link com.khulnasoft.spark.connector.japi.RDDAndDStreamCommonJavaFunctions.WriterBuilder}
     *
     * @see com.khulnasoft.spark.connector.japi.CassandraJavaUtil#mapToRow(Class, ColumnMapper)
     * @see com.khulnasoft.spark.connector.japi.CassandraJavaUtil#mapToRow(Class, java.util.Map)
     * @see com.khulnasoft.spark.connector.japi.CassandraJavaUtil#mapToRow(Class, org.apache.commons.lang3.tuple.Pair[])
     */
