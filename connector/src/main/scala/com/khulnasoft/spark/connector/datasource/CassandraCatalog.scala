...
import com.khulnasoft.oss.driver.api.core.CqlIdentifier.fromInternal
import com.khulnasoft.oss.driver.api.core.metadata.Metadata
import com.khulnasoft.oss.driver.api.core.metadata.schema.{ClusteringOrder, KeyspaceMetadata, RelationMetadata, TableMetadata}
import com.khulnasoft.oss.driver.api.querybuilder.SchemaBuilder
import com.khulnasoft.oss.driver.api.querybuilder.schema._
import com.khulnasoft.oss.driver.internal.core.metadata.schema.parsing.RelationParser
import com.khulnasoft.spark.connector.cql.CassandraConnector
import com.khulnasoft.spark.connector.datasource.CassandraSourceUtil._
import com.khulnasoft.spark.connector.util.{Logging, NameTools}
