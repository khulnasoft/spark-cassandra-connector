...
import com.khulnasoft.spark.connector.rdd.ClusteringOrder.{Ascending, Descending}
import com.khulnasoft.spark.connector.rdd.reader._
import com.khulnasoft.spark.connector.types.TypeConverter
import com.khulnasoft.spark.connector.util.ConfigCheck
import com.khulnasoft.spark.connector.{ColumnSelector, SomeColumns, _}
...
abstract class CassandraRDD[R : ClassTag](
  ...
  /** Narrows down the selected set of columns.
    ...
    * conversions included in [[com.khulnasoft.spark.connector]] package make it possible to provide
