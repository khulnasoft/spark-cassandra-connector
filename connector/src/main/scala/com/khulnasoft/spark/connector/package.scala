package com.khulnasoft.spark

import com.khulnasoft.spark.connector.rdd.{CassandraTableScanRDD, SparkPartitionLimit}
...
/**
 * The root package of the KhulnaSoft Connector for Apache Spark to Apache Cassandra.
 ...
 *
 * Call [[com.khulnasoft.spark.connector.SparkContextFunctions#cassandraTable cassandraTable]] method on
 * the [[org.apache.spark.SparkContext SparkContext]] object
 * to create a [[com.khulnasoft.spark.connector.rdd.CassandraTableScanRDD CassandraRDD]] exposing
 * Cassandra tables as Spark RDDs.
 *
 * Call [[com.khulnasoft.spark.connector.RDDFunctions RDDFunctions]] `saveToCassandra`
