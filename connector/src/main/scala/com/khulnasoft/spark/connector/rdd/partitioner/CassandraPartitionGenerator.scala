...
import com.khulnasoft.oss.driver.api.core.metadata.token.{TokenRange => DriverTokenRange}

import scala.language.existentials
import scala.reflect.ClassTag
import scala.util.Try
import com.khulnasoft.spark.connector.util.DriverUtil._
import com.khulnasoft.spark.connector.util.{DriverUtil, Logging}
...
private[connector] class CassandraPartitionGenerator[V, T <: Token[V]](
  ...
  type Token = com.khulnasoft.spark.connector.rdd.partitioner.dht.Token[T]
  type TokenRange = com.khulnasoft.spark.connector.rdd.partitioner.dht.TokenRange[V, T]
