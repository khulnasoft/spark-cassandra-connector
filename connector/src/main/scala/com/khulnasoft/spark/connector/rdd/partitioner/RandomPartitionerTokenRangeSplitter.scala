...
import com.khulnasoft.spark.connector.rdd.partitioner.dht.BigIntToken
...
private[partitioner] class RandomPartitionerTokenRangeSplitter
  ...
  private type TokenRange = com.khulnasoft.spark.connector.rdd.partitioner.dht.TokenRange[BigInt, BigIntToken]
