...
class SparkContextFunctions(@transient val sc: SparkContext) extends Serializable {
  ...
  /** Returns a view of a Cassandra table as `CassandraRDD`.
    ...
    * `com.khulnasoft.spark.connector._`
    *
    ...
    *   - a tuple containing column values in the same order as columns selected by [[com.khulnasoft.spark.connector.rdd.CassandraRDD#select CassandraRDD#select]]
    *   - object of a user defined class, populated by appropriate [[com.khulnasoft.spark.connector.mapper.ColumnMapper ColumnMapper]]
    *
    * Example:
    * {{{
