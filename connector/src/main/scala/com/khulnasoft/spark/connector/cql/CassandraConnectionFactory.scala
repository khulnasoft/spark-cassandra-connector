...
import com.khulnasoft.bdp.spark.ContinuousPagingScanner
import com.khulnasoft.dse.driver.api.core.DseProtocolVersion
import com.khulnasoft.dse.driver.api.core.config.DseDriverOption
import com.khulnasoft.oss.driver.api.core.CqlSession
import com.khulnasoft.oss.driver.api.core.config.DefaultDriverOption._
import com.khulnasoft.oss.driver.api.core.config.{DriverConfigLoader, ProgrammaticDriverConfigLoaderBuilder => PDCLB}
import com.khulnasoft.oss.driver.internal.core.connection.ExponentialReconnectionPolicy
...
import com.khulnasoft.spark.connector.util.{ConfigParameter, DeprecatedConfigParameter, ReflectionUtil}
...
object DefaultConnectionFactory extends CassandraConnectionFactory {
  @transient
  lazy private val logger = LoggerFactory.getLogger("com.khulnasoft.spark.connector.cql.CassandraConnectionFactory")
