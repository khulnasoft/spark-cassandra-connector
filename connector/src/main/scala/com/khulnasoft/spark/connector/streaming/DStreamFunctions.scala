...
import com.khulnasoft.spark.connector.cql.{CassandraConnector, CassandraConnectorConf}
import com.khulnasoft.spark.connector.rdd.partitioner.{CassandraPartitionedRDD, ReplicaPartitioner}
import com.khulnasoft.spark.connector.rdd.ValidRDDType
...
class DStreamFunctions[T](dstream: DStream[T])
  ...
  /**
   * Performs [[com.khulnasoft.spark.connector.writer.WritableToCassandra]] for each produced RDD.
  ...
  /**
    ...
    * @see [[com.khulnasoft.spark.connector.writer.WritableToCassandra]]
    */
  ...
  /**
   * Transforms RDDs with [[com.khulnasoft.spark.connector.RDDFunctions.repartitionByCassandraReplica]]
  ...
  /**
   * Transforms RDDs with [[com.khulnasoft.spark.connector.RDDFunctions.joinWithCassandraTable]]
   * for each produced RDD
   */
