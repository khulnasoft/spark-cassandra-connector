...
import com.khulnasoft.oss.driver.api.core.DefaultProtocolVersion.V4
...
import com.khulnasoft.spark.connector.datasource.CassandraSourceUtil
import com.khulnasoft.spark.connector.types.{BigIntType, BlobType, BooleanType, ColumnType, DateType, DecimalType, DoubleType, FloatType, IntType, ListType, MapType, SmallIntType, TimestampType, TinyIntType, VarCharType}
