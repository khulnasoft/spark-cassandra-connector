...
import com.khulnasoft.spark.connector.rdd.partitioner.dht.LongToken
...
private[partitioner] class Murmur3PartitionerTokenRangeSplitter
  ...
  private type TokenRange = com.khulnasoft.spark.connector.rdd.partitioner.dht.TokenRange[Long, LongToken]
