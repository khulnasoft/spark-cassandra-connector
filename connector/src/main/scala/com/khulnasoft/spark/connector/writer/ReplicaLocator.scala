...
import com.khulnasoft.spark.connector.util.{DriverUtil, Logging, tableFromCassandra}
 ...
 * by the [[com.khulnasoft.spark.connector.RDDFunctions.keyByCassandraReplica]] method. Uses the Java
