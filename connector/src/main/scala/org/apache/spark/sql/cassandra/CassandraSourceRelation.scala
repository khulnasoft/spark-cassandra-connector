...
import com.khulnasoft.spark.connector.datasource.{CassandraScan, CassandraTable}
...
object SolrConstants {
  val DseSolrIndexClassName = "com.khulnasoft.bdp.search.solr.Cql3SolrSecondaryIndex"
