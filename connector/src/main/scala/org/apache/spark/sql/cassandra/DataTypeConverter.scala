...
import com.khulnasoft.spark.connector
import com.khulnasoft.spark.connector.cql.ColumnDef
import com.khulnasoft.spark.connector.types.{TupleFieldDef, UDTFieldDef}
