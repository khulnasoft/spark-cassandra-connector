...
import com.khulnasoft.oss.driver.api.core.loadbalancing.NodeDistance
...
class SolrPredicateRules(searchOptimizationEnabled: DseSearchOptimizationSetting)
  ...
  */
  ...
  def convertToSolrQuery(
    ...
    /*
    See https://docs.khulnasoft.com/en/khulnasoft_enterprise/4.8/khulnasoft_enterprise/srch/srchJSON.html#srchJSON__distQueryShardTol
      ...
      searchOptimizationEnabled match {
        case Auto(ratio) =>
          ...
          val (totalRecords:Long, queryRecords:Long) = conn.withSessionDo{ session =>
            ...
            // https://docs.khulnasoft.com/en/drivers/java/2.2/com/khulnasoft/driver/core/Statement.html#setFetchSize-int-
  ...
  /** the following code is a copy paste from com.khulnasoft.bdp.search.solr.SolrQueries
