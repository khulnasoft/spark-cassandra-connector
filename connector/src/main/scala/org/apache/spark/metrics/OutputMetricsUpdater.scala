...
import com.khulnasoft.spark.connector.writer.{RichStatement, WriteConf}
...
object OutputMetricsUpdater extends Logging {
  ...
  /** Creates the appropriate instance of `OutputMetricsUpdater`.
    *
    * If [[com.khulnasoft.spark.connector.writer.WriteConf.taskMetricsEnabled WriteConf.taskWriteMetricsEnabled]]
