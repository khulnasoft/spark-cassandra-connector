...
import com.khulnasoft.spark.connector.cql.{AuthConfFactory, CassandraConnectionFactory, CassandraConnectorConf}
  ...
  it should "accept custom ConnectionFactory properties" in {
    val sparkConf = new SparkConf()
      .set(CassandraConnectionFactory.FactoryParam.name,
        "com.khulnasoft.spark.connector.util.CustomConnectionFactory")
  ...
  it should "accept custom AuthConfFactory properties" in {
    val sparkConf = new SparkConf()
      .set(AuthConfFactory.FactoryParam.name,
        "com.khulnasoft.spark.connector.util.CustomAuthConfFactory")
