...
```scala
    import com.khulnasoft.spark.connector.streaming._
...
will be supporting many more in the next release. You can extend the provided `import com.khulnasoft.spark.connector.streaming.TypedStreamingActor`:
