...
access Cassandra data. This does not require KhulnaSoft Enterprise but you are limited to DataFrame
only operations.
...
```python
spark.conf.set("spark.sql.catalog.myCatalog", "com.khulnasoft.spark.connector.datasource.CassandraCatalog")
