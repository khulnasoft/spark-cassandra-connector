...
Refer to [Khulnasoft](https://docs.khulnasoft.com/en/) and [Cassandra documentation](https://cassandra.apache.org/doc/latest/getting_started/index.html)
...
The dependencies are easily retrieved via Maven Central 
    ...
    libraryDependencies += "com.khulnasoft.spark" % "spark-cassandra-connector_2.12" % "3.5.1"
...
Spark Driver and all Spark Executors.
    ...
    $SPARK_HOME/bin/spark-shell --packages com.khulnasoft.spark:spark-cassandra-connector_2.12:3.5.1
    $SPARK_HOME/bin/spark-submit --packages com.khulnasoft.spark:spark-cassandra-connector_2.12:3.5.1

For the list of available versions, see:
- https://repo1.maven.org/maven2/com/khulnasoft/spark/spark-cassandra-connector_2.12/
...
the default Spark Configuration pass key value pairs with `--conf`
    ...
    $SPARK_HOME/bin/spark-shell --conf spark.cassandra.connection.host=127.0.0.1 \
                                --packages com.khulnasoft.spark:spark-cassandra-connector_2.12:3.5.1
                                --conf spark.sql.extensions=com.khulnasoft.spark.connector.CassandraSparkExtensions
...
```scala
spark.conf.set(s"spark.sql.catalog.mycatalog", "com.khulnasoft.spark.connector.datasource.CassandraCatalog")
```
