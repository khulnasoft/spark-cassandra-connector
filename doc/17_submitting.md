...
[main artifact](https://search.maven.org/artifact/com.khulnasoft.spark/spark-cassandra-connector_2.12)
and all of its dependencies on the app's classpath.
```
spark-submit --packages com.khulnasoft.spark:spark-cassandra-connector_<scala_version>:<scc_version> ...
```
...
[main artifact](https://search.maven.org/artifact/com.khulnasoft.spark/spark-cassandra-connector_2.12) with 
...
[assembly](https://search.maven.org/artifact/com.khulnasoft.spark/spark-cassandra-connector-assembly_2.12).
It's a single jar with all the needed dependency classes included. It is suitable for using with `--jars` 
option.

```
spark-submit --jars com.khulnasoft.spark:spark-cassandra-connector-assembly_<scala_version>:<scc_version> ...
```
