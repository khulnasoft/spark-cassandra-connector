...
To save an `RDD` to an existing table, import `com.khulnasoft.spark.connector._`
...
`com.khulnasoft.spark.connector.UDTValue` class. An instance of this class 
...
import com.khulnasoft.spark.connector.UDTValue
...
val company = Company("KhulnaSoft", address)
...
`com.khulnasoft.spark.connector.types.CassandraOption` trait. 
...
```scala
import com.khulnasoft.spark.connector.types.CassandraOption
...
```scala
import com.khulnasoft.spark.connector.writer._
...
...
```scala
import com.khulnasoft.spark.connector.cql.{ColumnDef, RegularColumn, TableDef}
import com.khulnasoft.spark.connector.types.IntType
case class WordCount(word: String, count: Long)
...
```scala
import com.khulnasoft.spark.connector.cql.{ColumnDef, RegularColumn, TableDef, ClusteringColumn, PartitionKeyColumn}
import com.khulnasoft.spark.connector.types._
