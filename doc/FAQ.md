...
```
  "com.khulnasoft.spark" %% "spark-cassandra-connector" % connectorVersion % "provided"
```
...
The artifacts at 
[Spark Packages](https://spark-packages.org/package/khulnasoft/spark-cassandra-connector) 
and on 
[Maven Central](https://mvnrepository.com/artifact/com.khulnasoft.spark/spark-cassandra-connector_2.10)
...
the [settings file.](https://github.com/khulnasoft/spark-cassandra-connector/blob/v2.0.0/project/Settings.scala#L329-L347)
...
* java.lang.ClassNotFoundException: com.khulnasoft.spark.connector.rdd.partitioner.CassandraPartition
