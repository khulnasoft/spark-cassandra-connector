...
object Publishing extends sbt.librarymanagement.DependencyBuilders {
  ...
  val OurScmInfo =
    Some(
      ScmInfo(
        url("https://github.com/khulnasoft/spark-cassandra-connector"),
        "scm:git@github.com:khulnasoft/spark-cassandra-connector.git"
      )
    )
  ...
  val OurDevelopers =
      <developers>
        <developer>
          ...
          <organization>KhulnaSoft</organization>
          <organizationUrl>http://www.khulnasoft.com/</organizationUrl>
        </developer>
        <developer>
