...
ThisBuild / homepage := Some(url("https://github.com/khulnasoft/spark-cassandra-connector"))
ThisBuild / licenses := List("Apache 2" -> new URL("http://www.apache.org/licenses/LICENSE-2.0.txt") )
ThisBuild / organization := "com.khulnasoft.spark"
ThisBuild / organizationName := "Khulnasoft"
ThisBuild / organizationHomepage := Some(url("https://www.khulnasoft.com"))
...
lazy val assemblySettings = Seq(
  ...
  assembly / assemblyShadeRules := {
    Seq(
      ShadeRule.rename("com.typesafe.config.**" -> s"shade.com.khulnasoft.spark.connector.@0").inAll
    )
  },
)
...
val annotationProcessor = Seq(
  "-processor", "com.khulnasoft.oss.driver.internal.mapper.processor.MapperProcessor"
)
